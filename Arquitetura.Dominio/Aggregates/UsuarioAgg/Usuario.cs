...
namespace Arquitetura.Dominio.Aggregates.UsuarioAgg
{
    public class Usuario : Entity, IValidator
    {
        ...
        public IEnumerable<string[]> Validate()
        {
            ...
            if (!Sexo.HasValue)
            {
                validationResults.Add(new string[] { "Sexo é obrigatório.", "Sexo" });
            }
            ...
            else if (Celular.Length < 14 || Celular.Length > 15)
            {
            ...
            {
                validationResults.Add(new string[] { "Número é obrigatório.", "Numero" });
            }
            ...
            {
                validationResults.Add(new string[] { "CEP é obrigatório.", "Cep" });
            }
